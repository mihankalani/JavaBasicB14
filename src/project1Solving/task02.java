...
public class task02 {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * Please enter how many countries you want to process 1 Please Enter the
		 * country name United states of America Please Enter the capital for United
		 * states of America DC The Country United states of America Has the capital DC
		 */
